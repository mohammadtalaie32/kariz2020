...
<html lang="en">
  <head>
    ...
    <link href="{{asset("admin_pages/css/bootstrap-reset.css")}}" rel="stylesheet">
    <!--external css-->
    <link href="{{asset("admin_pages/assets/font-awesome/css/font-awesome.css")}}" rel="stylesheet" />
    <link href="{{ asset("admin_pages/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css")}}" rel="stylesheet" type="text/css" media="screen"/>
    
    <link rel="stylesheet" href="{{asset("admin_pages/css/owl.carousel.css") }}" type="text/css">
    <!-- Custom styles for this template -->
    <link href="{{ asset("admin_pages/css/style.css") }}" rel="stylesheet">
    <link href="{{ asset("admin_pages/css/style-responsive.css") }}" rel="stylesheet" />
