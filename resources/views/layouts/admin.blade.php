...
<script src={{asset('admin_panel/js/core/popper.min.js')}}></script>
<script src={{asset('admin_panel/js/core/bootstrap-material-design.min.js')}}></script>
<script src="https://unpkg.com/default-passive-events"></script>
<script src={{asset('admin_panel/js/plugins/perfect-scrollbar.jquery.min.js')}}></script>
<!-- Place this tag in your head or just before your close body tag. -->
<script async defer src="https://buttons.github.io/buttons.js"></script>
<!--  Google Maps Plugin    -->
<script src="https://maps.googleapis.com/maps/api/js?key=YOUR_KEY_HERE"></script>
<!-- Chartist JS -->
<script src={{asset('admin_panel/js/plugins/chartist.min.js')}}></script>
<!--  Notifications Plugin    -->
<script src={{ asset('admin_panel/js/plugins/bootstrap-notify.js') }}></script>
<!-- Control Center for Material Dashboard: parallax effects, scripts for the example pages etc -->
<script src={{asset('admin_panel/js/material-dashboard.js?v=2.1.0')}}></script>
<!-- Material Dashboard DEMO methods, don't include it in your project! -->
<script src={{asset('admin_panel/demo/demo.js')}}></script>
<script>
