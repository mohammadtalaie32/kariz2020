...
<head>
    ...
    <!-- Bootstrap CSS File -->
    <link href="{{ asset("assetlib/bootstrap/css/bootstrap.min.css") }}" rel="stylesheet">
    ...
    <section  class="clearfix" style="background-color:gray;">
        <div class="container" style="background-color:gray;">
            ...
            <div class="intro-info " style="background-color:gray;">
                ...
                <div>
                    <a href="#about" class="btn-get-started scrollto" style="background-color:ligthgray;"><button style="background-color:lightgray">همین حالا شروع کن</button></a>
