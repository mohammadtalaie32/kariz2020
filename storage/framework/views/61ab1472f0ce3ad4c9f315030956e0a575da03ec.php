    ...
    <div class="container">
        ...
        <nav class="main-nav float-right d-none d-lg-block ">
            <ul>
                ...
                <li><a href="#clients">حامیان</a></li>
                <li><a href="#team">کتاب ها</a></li>
                <li><a href="#services">کارگاه های اموزشی</a></li>
                <li><a href="#about">اطلاعیه ها</a></li>
...
<div id="intro" class="jumbotron jumbotron-fluid bg-dark mb-0 ">
...
<footer id="footer">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 footer-info">
                    <h3 class="text-warning">درباره موسسه کاریز</h3>
                ...
                <div class="col-lg-4 col-md-6 footer-contact ">
                    ...
                    <p>
                        فایور prodevloper00 <br>
                        <strong>تلفن:</strong> +98 000000000<br>
                        <strong>ایمیل:</strong> contact@kariz.ca<br>
                    </p>
    ...
    -->
             <a href="https://bootstrapmade.com/ ">Designed and Developed by prodeveloper00 team</a>
        </div>
    </div>
</footer>
<!-- #footer -->
