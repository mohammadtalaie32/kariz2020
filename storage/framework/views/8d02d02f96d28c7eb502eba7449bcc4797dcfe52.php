<?php $__env->startSection('content'); ?>
    ...
    <form method="POST" action="/admin/courses/update/<?php echo e($course->id); ?>" enctype="multipart/form-data">
        ...
        <br>
        <input type="text" style="font-size:150%;border:2px solid gray;Border-radius:10px;max-width:100%" size="50" name="name" value="<?php echo e($course->name); ?>" required maxlength="100">
        <br>
        <br>
        <label for="teacher" style="font-size:200%">نام مدرس دوره :</label>
        <br>
        <input type="text" style="font-size:150%;border:2px solid gray;Border-radius:10px;max-width:100%" size="50" name="teacher" value="<?php echo e($course->teacher); ?>" required maxlength="100">
        <br>
        <br>
        <label for = "date" style="font-size:200%">تاریخ دوره :</label>
        <br>
        <input type="text" style="font-size:150%;border:2px solid gray;Border-radius:10px;max-width:100%" size="50" name="date" value="<?php echo e($course->date); ?>" required maxlength="100">
        <br>
        <br>
        ...
        <input type  = "file" name="picture" style="color:white" value="<?php echo e($picture); ?>">
        <br>
        <br>
