<?php $__env->startSection('content'); ?>
    <fieldset style="border: 1px solid white;padding:30px;max-width:100%">
        ...
        <br>
        <input type="text" style="font-size:150%;border:2px solid gray;Border-radius:10px;max-width:100%" size="50" name="title" value="<?php echo e($feed->title); ?>" required maxlength="100">
        <br>
        <br>
